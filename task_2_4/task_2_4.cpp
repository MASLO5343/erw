...
void countCharactersInFileOperation() {
    ...
    inputFile.close();
    std::cout << COLOR_GREEN_OUTPUT << "Total number of characters in text.txt: " << content.length() << RESET_OUTPUT << "\n";
}
...
int main() {
    ...
    countCharactersInFileOperation();
